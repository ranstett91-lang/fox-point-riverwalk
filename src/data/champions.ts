...
//
// Each role string self-documents scope ("U.S. Representative",
// "Delaware State Senator", "New Castle County Councilman"), so no
// separate scope field is carried on the data.
